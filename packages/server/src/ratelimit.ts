import type { RatelimitAlgorithm, RatelimitNativeType, RatelimitUserOptions } from "./ratelimit/make.ts"
...
export const annotations = (config: RatelimitUserOptions) =>
  Context.make(RatelimitApiConfig, RatelimitApiConfig.of(config))
