...
import { SitemapBuilder } from "../src/sitemap.ts"

describe.concurrent("SitemapBuilder", () => {
  it("snapshot test to exclude undefined values from final sitemap", () => {
    // Builder instance
  ...
  it("snapshot test for google news sitemap", () => {
    // Builder instance
    const builder = new SitemapBuilder()
  ...
  it("snapshot test for image sitemap", () => {
    // Builder instance
    const builder = new SitemapBuilder()
  ...
  it("image sitemap generates correctly encoded results", () => {
    // Builder instance
    const builder = new SitemapBuilder()
  ...
  it("snapshot test for video sitemap", () => {
    // Builder instance
    const builder = new SitemapBuilder()
