...
export const PaymentMethodDetailsPaymentRecordIdeal = Schema.Struct({
...
export type PaymentMethodDetailsPaymentRecordIdeal = typeof PaymentMethodDetailsPaymentRecordIdeal.Type
