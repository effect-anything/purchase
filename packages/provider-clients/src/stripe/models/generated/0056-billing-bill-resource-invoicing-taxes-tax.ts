...
export const BillingBillResourceInvoicingTaxesTax = Schema.Struct({
  ...
  tax_rate_details: Schema.NullOr(
    Schema.suspend(
      (): Schema.Schema<Models.BillingBillResourceInvoicingTaxesTaxRateDetails, any, any> =>
        Models.BillingBillResourceInvoicingTaxesTaxRateDetails as Schema.Schema<
  ...
  taxability_reason: Schema.Literal(
    "customer_exempt",
    "not_available",
    "not_collecting",
    "not_subject_to_tax",
