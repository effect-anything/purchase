...
export const PaymentMethodDetailsPaymentRecordBancontact = Schema.Struct({
...
export type PaymentMethodDetailsPaymentRecordBancontact = typeof PaymentMethodDetailsPaymentRecordBancontact.Type
