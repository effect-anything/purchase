...
export const CheckoutCardPaymentMethodOptions = Schema.Struct({
  ...
  installments: Schema.optional(Schema.suspend((): typeof Models.CheckoutCardInstallmentsOptions => Models.CheckoutCardInstallmentsOptions)),
  ...
  restrictions: Schema.optional(Schema.suspend((): typeof Models.PaymentPagesPrivateCardPaymentMethodOptionsResourceRestrictions => Models.PaymentPagesPrivateCardPaymentMethodOptionsResourceRestrictions)),
