...
export type ApiErrors = {
  ...
  readonly payment_intent?: Models.PaymentIntent
  readonly payment_method?: Models.PaymentMethod
  readonly payment_method_type?: string
  readonly request_log_url?: string
  readonly setup_intent?: Models.SetupIntent
  readonly source?: Models.PaymentSource
...
export const ApiErrors = Schema.Struct({
  ...
  type: Schema.Literal("api_error", "card_error", "idempotency_error", "invalid_request_error")
})
