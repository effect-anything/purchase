...
export const IssuingPhysicalBundle = Schema.Struct({
  features: Schema.suspend(
    (): Schema.Schema<Models.IssuingPhysicalBundleFeatures, any, any> =>
      Models.IssuingPhysicalBundleFeatures as Schema.Schema<Models.IssuingPhysicalBundleFeatures, any, any>
  ),
  id: Schema.String,
