...
export const SubscriptionsResourcePaymentSettings = Schema.Struct({
  payment_method_options: Schema.NullOr(Schema.suspend((): typeof Models.SubscriptionsResourcePaymentMethodOptions => Models.SubscriptionsResourcePaymentMethodOptions)),
