...
export const PaymentIntentNextActionDisplayBankTransferInstructions = Schema.Struct({
  ...
  financial_addresses: Schema.optional(
    Schema.Array(
      Schema.suspend(
        (): Schema.Schema<Models.FundingInstructionsBankTransferFinancialAddress, any, any> =>
          Models.FundingInstructionsBankTransferFinancialAddress as Schema.Schema<
            Models.FundingInstructionsBankTransferFinancialAddress,
            any,
            any
          >
      )
...
export type PaymentIntentNextActionDisplayBankTransferInstructions =
  typeof PaymentIntentNextActionDisplayBankTransferInstructions.Type
