  ...
  currency_options: Schema.optional(
    Schema.Record({
      ...
      value: Schema.suspend(
        (): Schema.Schema<Models.PromotionCodeCurrencyOption, any, any> =>
          Models.PromotionCodeCurrencyOption as Schema.Schema<Models.PromotionCodeCurrencyOption, any, any>
      )
    })
  ),
