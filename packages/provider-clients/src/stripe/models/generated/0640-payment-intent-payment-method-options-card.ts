...
export const PaymentIntentPaymentMethodOptionsCard = Schema.Struct({
  ...
  installments: Schema.NullOr(
    Schema.suspend(
      (): Schema.Schema<Models.PaymentMethodOptionsCardInstallments, any, any> =>
        Models.PaymentMethodOptionsCardInstallments as Schema.Schema<
          Models.PaymentMethodOptionsCardInstallments,
          any,
          any
        >
    )
  ...
  mandate_options: Schema.NullOr(
    Schema.suspend(
      (): Schema.Schema<Models.PaymentMethodOptionsCardMandateOptions, any, any> =>
        Models.PaymentMethodOptionsCardMandateOptions as Schema.Schema<
          Models.PaymentMethodOptionsCardMandateOptions,
          any,
          any
        >
    )
