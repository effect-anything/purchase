...
export const PaymentIntentPaymentMethodOptionsBacsDebit = Schema.Struct({
  mandate_options: Schema.optional(
    Schema.suspend(
      (): Schema.Schema<Models.PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit, any, any> =>
        Models.PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit as Schema.Schema<
          Models.PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit,
          any,
          any
        >
    )
