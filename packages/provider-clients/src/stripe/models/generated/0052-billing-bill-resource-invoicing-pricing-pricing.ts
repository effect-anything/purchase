...
export const BillingBillResourceInvoicingPricingPricing = Schema.Struct({
  price_details: Schema.optional(
    Schema.suspend(
      (): Schema.Schema<Models.BillingBillResourceInvoicingPricingPricingPriceDetails, any, any> =>
        Models.BillingBillResourceInvoicingPricingPricingPriceDetails as Schema.Schema<
