...
export const PaymentPagesCheckoutSessionShippingCost = Schema.Struct({
...
export type PaymentPagesCheckoutSessionShippingCost = typeof PaymentPagesCheckoutSessionShippingCost.Type
