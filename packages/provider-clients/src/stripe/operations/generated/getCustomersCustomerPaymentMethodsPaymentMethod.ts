...
export type GetCustomersCustomerPaymentMethodsPaymentMethodInput = typeof GetCustomersCustomerPaymentMethodsPaymentMethodInput.Type

export const GetCustomersCustomerPaymentMethodsPaymentMethodOutput = Models.PaymentMethod
export type GetCustomersCustomerPaymentMethodsPaymentMethodOutput = typeof GetCustomersCustomerPaymentMethodsPaymentMethodOutput.Type
 ...
 */
export const getCustomersCustomerPaymentMethodsPaymentMethod = (input: GetCustomersCustomerPaymentMethodsPaymentMethodInput) =>
  StripeClient.pipe(Effect.flatMap((client) => client.request(getCustomersCustomerPaymentMethodsPaymentMethodOperation, input)))
