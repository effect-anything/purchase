...
export const PostSubscriptionsSubscriptionExposedIdInput = Schema.Struct({
  subscription_exposed_id: Schema.String,
  add_invoice_items: Schema.optional(Schema.Array(Schema.Struct({
  ...
  period: Schema.optional(Schema.Struct({
  end: Schema.Struct({
  ...
  billing_thresholds: Schema.optional(Schema.Union(Schema.Struct({
  amount_gte: Schema.optional(Schema.Number),
  reset_billing_cycle_anchor: Schema.optional(Schema.Boolean),
}), Schema.Literal(""))),
  cancel_at: Schema.optional(Schema.Union(Schema.Number, Schema.Literal(""), Schema.Literal("max_period_end", "min_period_end"))),
  ...
  default_source: Schema.optional(Schema.Union(Schema.String, Schema.Literal(""))),
  ...
  pause_collection: Schema.optional(Schema.Union(Schema.Struct({
  behavior: Schema.Literal("keep_as_draft", "mark_uncollectible", "void"),
  resumes_at: Schema.optional(Schema.Number),
}), Schema.Literal(""))),
  payment_behavior: Schema.optional(Schema.Literal("allow_incomplete", "default_incomplete", "error_if_incomplete", "pending_if_incomplete")),
  payment_settings: Schema.optional(Schema.Struct({
  payment_method_options: Schema.optional(Schema.Struct({
  acss_debit: Schema.optional(Schema.Union(Schema.Struct({
  ...
  bancontact: Schema.optional(Schema.Union(Schema.Struct({
  preferred_language: Schema.optional(Schema.Literal("de", "en", "fr", "nl")),
}), Schema.Literal(""))),
  card: Schema.optional(Schema.Union(Schema.Struct({
  mandate_options: Schema.optional(Schema.Struct({
  amount: Schema.optional(Schema.Number),
  amount_type: Schema.optional(Schema.Literal("fixed", "maximum")),
  description: Schema.optional(Schema.String),
})),
  network: Schema.optional(Schema.Literal("amex", "cartes_bancaires", "diners", "discover", "eftpos_au", "girocard", "interac", "jcb", "link", "mastercard", "unionpay", "unknown", "visa")),
  request_three_d_secure: Schema.optional(Schema.Literal("any", "automatic", "challenge")),
}), Schema.Literal(""))),
  customer_balance: Schema.optional(Schema.Union(Schema.Struct({
  ...
  konbini: Schema.optional(Schema.Union(Schema.Struct({

}), Schema.Literal(""))),
  payto: Schema.optional(Schema.Union(Schema.Struct({
  mandate_options: Schema.optional(Schema.Struct({
  amount: Schema.optional(Schema.Number),
  ...
  pix: Schema.optional(Schema.Union(Schema.Struct({
  ...
  sepa_debit: Schema.optional(Schema.Union(Schema.Struct({

}), Schema.Literal(""))),
  upi: Schema.optional(Schema.Union(Schema.Struct({
  mandate_options: Schema.optional(Schema.Struct({
  amount: Schema.optional(Schema.Number),
  amount_type: Schema.optional(Schema.Literal("fixed", "maximum")),
  description: Schema.optional(Schema.String),
  ...
  us_bank_account: Schema.optional(Schema.Union(Schema.Struct({
  ...
  payment_method_types: Schema.optional(Schema.Union(Schema.Array(Schema.Literal("ach_credit_transfer", "ach_debit", "acss_debit", "affirm", "amazon_pay", "au_becs_debit", "bacs_debit", "bancontact", "boleto", "card", "cashapp", "crypto", "custom", "customer_balance", "eps", "fpx", "giropay", "grabpay", "ideal", "jp_credit_transfer", "kakao_pay", "klarna", "konbini", "kr_card", "link", "multibanco", "naver_pay", "nz_bank_account", "p24", "pay_by_bank", "payco", "paynow", "paypal", "payto", "pix", "promptpay", "revolut_pay", "sepa_credit_transfer", "sepa_debit", "sofort", "swish", "upi", "us_bank_account", "wechat_pay")), Schema.Literal(""))),
  save_default_payment_method: Schema.optional(Schema.Literal("off", "on_subscription")),
})),
  pending_invoice_item_interval: Schema.optional(Schema.Union(Schema.Struct({
  ...
  transfer_data: Schema.optional(Schema.Union(Schema.Struct({
...
export type PostSubscriptionsSubscriptionExposedIdInput = typeof PostSubscriptionsSubscriptionExposedIdInput.Type

export const PostSubscriptionsSubscriptionExposedIdOutput = Models.Subscription
export type PostSubscriptionsSubscriptionExposedIdOutput = typeof PostSubscriptionsSubscriptionExposedIdOutput.Type

export const postSubscriptionsSubscriptionExposedIdOperation = defineOperation({
  id: "stripe.PostSubscriptionsSubscriptionExposedId",
  method: "POST",
  ...
  bodyParams: ["add_invoice_items", "application_fee_percent", "automatic_tax", "billing_cycle_anchor", "billing_thresholds", "cancel_at", "cancel_at_period_end", "cancellation_details", "collection_method", "days_until_due", "default_payment_method", "default_source", "default_tax_rates", "description", "discounts", "expand", "invoice_settings", "items", "metadata", "off_session", "on_behalf_of", "pause_collection", "payment_behavior", "payment_settings", "pending_invoice_item_interval", "proration_behavior", "proration_date", "transfer_data", "trial_end", "trial_from_plan", "trial_settings"]
})

/**
 * Update a subscription
 */
export const postSubscriptionsSubscriptionExposedId = (input: PostSubscriptionsSubscriptionExposedIdInput) =>
  StripeClient.pipe(Effect.flatMap((client) => client.request(postSubscriptionsSubscriptionExposedIdOperation, input)))
