...
export const PostPricesPriceInput = Schema.Struct({
  ...
  currency_options: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Struct({
...
export const postPricesPriceOperation = defineOperation({
  ...
  contentType: "form",
  pathParams: ["price"],
  bodyParams: ["active", "currency_options", "expand", "lookup_key", "metadata", "nickname", "tax_behavior", "transfer_lookup_key"]
})
