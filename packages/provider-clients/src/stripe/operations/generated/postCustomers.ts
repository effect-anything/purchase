...
export const PostCustomersInput = Schema.Struct({
  ...
  tax_id_data: Schema.optional(Schema.Array(Schema.Struct({
...
export const postCustomersOperation = defineOperation({
  ...
  status: [200],
  contentType: "form",
  bodyParams: ["address", "balance", "business_name", "cash_balance", "description", "email", "expand", "individual_name", "invoice_prefix", "invoice_settings", "metadata", "name", "next_invoice_sequence", "payment_method", "phone", "preferred_locales", "shipping", "source", "tax", "tax_exempt", "tax_id_data", "test_clock", "validate"]
})
