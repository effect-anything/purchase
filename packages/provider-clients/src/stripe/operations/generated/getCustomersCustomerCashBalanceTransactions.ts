...
export type GetCustomersCustomerCashBalanceTransactionsInput = typeof GetCustomersCustomerCashBalanceTransactionsInput.Type
...
export type GetCustomersCustomerCashBalanceTransactionsOutput = typeof GetCustomersCustomerCashBalanceTransactionsOutput.Type
...
export const getCustomersCustomerCashBalanceTransactions = (input: GetCustomersCustomerCashBalanceTransactionsInput) =>
  StripeClient.pipe(Effect.flatMap((client) => client.request(getCustomersCustomerCashBalanceTransactionsOperation, input)))
