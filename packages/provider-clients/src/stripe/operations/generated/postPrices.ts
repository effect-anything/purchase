...
export const PostPricesInput = Schema.Struct({
  ...
  transform_quantity: Schema.optional(Schema.Struct({
...
export const postPricesOperation = defineOperation({
  ...
  status: [200],
  contentType: "form",
  bodyParams: ["active", "billing_scheme", "currency", "currency_options", "custom_unit_amount", "expand", "lookup_key", "metadata", "nickname", "product", "product_data", "recurring", "tax_behavior", "tiers", "tiers_mode", "transfer_lookup_key", "transform_quantity", "unit_amount", "unit_amount_decimal"]
})
