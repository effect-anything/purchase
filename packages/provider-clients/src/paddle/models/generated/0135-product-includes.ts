...
export const ProductIncludes = Schema.Struct({
  id: Schema.suspend((): Schema.Schema<Models.ProductId> => Models.ProductId),
  ...
  prices: Schema.optional(Schema.Array(Schema.suspend((): Schema.Schema<Models.Price> => Models.Price)))
})
