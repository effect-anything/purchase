...
export const SubscriptionIncludes = Schema.Struct({
  ...
  next_transaction: Schema.optional(Schema.NullOr(Schema.suspend(() => Models.SubscriptionNextTransaction))),
  recurring_transaction_details: Schema.optional(Schema.suspend(() => Models.TransactionPreviewDetails)),
})
