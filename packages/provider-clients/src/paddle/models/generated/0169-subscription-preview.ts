...
export const SubscriptionPreview = Schema.Struct({
  ...
  immediate_transaction: Schema.NullOr(
    Schema.suspend((): Schema.Schema<Models.SubscriptionNextTransaction> => Models.SubscriptionNextTransaction)
  ),
  next_transaction: Schema.NullOr(
    Schema.suspend((): Schema.Schema<Models.SubscriptionNextTransaction> => Models.SubscriptionNextTransaction)
  ),
  recurring_transaction_details: Schema.suspend(
    (): Schema.Schema<Models.TransactionPreviewDetails> => Models.TransactionPreviewDetails
  ),
  update_summary: Schema.NullOr(Schema.suspend((): Schema.Schema<Models.UpdateSummary> => Models.UpdateSummary)),
