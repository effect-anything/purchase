...
export type GetSubscriptionUpdatePaymentMethodTransactionInput = typeof GetSubscriptionUpdatePaymentMethodTransactionInput.Type
...
export type GetSubscriptionUpdatePaymentMethodTransactionOutput = typeof GetSubscriptionUpdatePaymentMethodTransactionOutput.Type
 ...
 */
export const getSubscriptionUpdatePaymentMethodTransaction = (input: GetSubscriptionUpdatePaymentMethodTransactionInput) =>
  PaddleClient.pipe(Effect.flatMap((client) => client.request(getSubscriptionUpdatePaymentMethodTransactionOperation, input)))
