...
export const SubscriptionEntity = Schema.Struct({
  ...
  product: Schema.Union(Schema.suspend(() => Models.ProductEntity), Schema.String),
  customer: Schema.Union(Schema.suspend(() => Models.CustomerEntity), Schema.String),
  items: Schema.optional(Schema.Array(Schema.suspend(() => Models.SubscriptionItemEntity))),
  collection_method: Schema.suspend(() => Models.SubscriptionCollectionMethod),
  status: Schema.suspend(() => Models.SubscriptionStatus),
  last_transaction_id: Schema.optional(Schema.String),
  last_transaction: Schema.optional(Schema.suspend(() => Models.TransactionEntity)),
