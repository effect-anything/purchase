...
export const CheckoutPublic = Schema.Struct({
  id: Schema.String,
  ...
  status: Schema.suspend(
    (): Schema.Schema<Models.CheckoutStatus, any, any> =>
      Models.CheckoutStatus as Schema.Schema<Models.CheckoutStatus, any, any>
  ),
...
export type CheckoutPublic = typeof CheckoutPublic.Type
