...
export const BenefitDownloadablesUpdate = Schema.Struct({
  ...
  type: Schema.String,
  properties: Schema.optional(Schema.NullOr(Schema.suspend((): typeof Models.BenefitDownloadablesCreateProperties => Models.BenefitDownloadablesCreateProperties))),
})
