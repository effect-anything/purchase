...
export const ProductPriceSeatBased = Schema.Struct({
  ...
  seat_tiers: Schema.suspend(
    (): Schema.Schema<Models.ProductPriceSeatTiersOutput, any, any> =>
      Models.ProductPriceSeatTiersOutput as Schema.Schema<Models.ProductPriceSeatTiersOutput, any, any>
  )
})
export type ProductPriceSeatBased = typeof ProductPriceSeatBased.Type
