...
export const SubscriptionsListInput = Schema.Struct({
  ...
  customer_cancellation_reason: Schema.optional(Schema.NullOr(Schema.Union(Models.CustomerCancellationReason, Schema.Array(Models.CustomerCancellationReason)))),
...
export const subscriptionsListOperation = defineOperation({
  ...
  status: [200],
  contentType: "json",
  queryParams: ["organization_id", "product_id", "customer_id", "external_customer_id", "discount_id", "active", "cancel_at_period_end", "customer_cancellation_reason", "canceled_at_after", "canceled_at_before", "page", "limit", "sorting", "metadata"]
})
