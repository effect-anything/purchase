...
export const ProductsUpdateInput = Schema.Struct({
  ...
  prices: Schema.optional(Schema.NullOr(Schema.Array(Schema.Union(Models.ExistingProductPrice, Schema.Union(Models.ProductPriceFixedCreate, Models.ProductPriceCustomCreate, Models.ProductPriceFreeCreate, Models.ProductPriceSeatBasedCreate, Models.ProductPriceMeteredUnitCreate))))),
...
export const productsUpdateOperation = defineOperation({
  ...
  contentType: "json",
  pathParams: ["id"],
  bodyParams: ["metadata", "trial_interval", "trial_interval_count", "name", "description", "recurring_interval", "recurring_interval_count", "is_archived", "visibility", "prices", "medias", "attached_custom_fields"]
})
