...
export const checkoutsClientConfirmOperation = defineOperation({
  ...
  bodyParams: ["custom_field_data", "product_id", "product_price_id", "amount", "seats", "is_business_customer", "customer_name", "customer_email", "customer_billing_name", "customer_billing_address", "customer_tax_id", "locale", "discount_code", "allow_trial", "confirmation_token_id"]
})
