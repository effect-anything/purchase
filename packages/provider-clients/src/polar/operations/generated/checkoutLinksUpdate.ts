...
export const checkoutLinksUpdateOperation = defineOperation({
  ...
  contentType: "json",
  pathParams: ["id"],
  bodyParams: ["trial_interval", "trial_interval_count", "metadata", "products", "label", "allow_discount_codes", "require_billing_address", "discount_id", "success_url", "return_url"]
})
