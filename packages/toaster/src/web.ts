...
import type { ExternalToast, PromiseData, PromiseT, titleT, ToasterMethods } from "./toaster.ts"
...
const convertToSonnerOptions = (data?: ExternalToast) => {
  ...
  if (data.descriptionClassName !== undefined) {
    options.descriptionClassName = data.descriptionClassName
  }
