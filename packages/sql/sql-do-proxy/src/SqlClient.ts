 ...
 * @since 1.0.0
 */
export const SqliteClient = Context.GenericTag<SqliteClient>("@effect-x/sql-do-proxy/sqlite-client")
    ...
    const makeConnection = Effect.gen(function* () {
      ...
      return identity<Connection>({
        execute(sql, params, transformRows_) {
          return transformRows_ ? Effect.map(runStatement(sql, params), transformRows_) : runStatement(sql, params)
        },
