...
const SqliteObjectRows_ = Schema.Array(Schema.Object)
export interface SqliteObjectRows extends Schema.Schema.Type<typeof SqliteObjectRows_> {}
export interface SqliteObjectRowsEncoded extends Schema.Schema.Encoded<typeof SqliteObjectRows_> {}
export const SqliteObjectRows: Schema.Schema<SqliteObjectRows, SqliteObjectRowsEncoded> = SqliteObjectRows_
...
const SqliteQueryStreamChunk = Schema.Struct({
  streamId: Schema.optionalWith(Schema.String, { exact: true }),
  rows: SqliteObjectRows,
  done: Schema.Boolean
})

export class SqliteQueryStreamOpen extends Schema.TaggedRequest<SqliteQueryStreamOpen>()("SqliteQueryStreamOpen", {
  failure: SqliteRunError,
  success: SqliteQueryStreamChunk,
  payload: {
    sql: Schema.String,
    params: SqliteParams
  }
...
export class SqliteQueryStreamNext extends Schema.TaggedRequest<SqliteQueryStreamNext>()("SqliteQueryStreamNext", {
  failure: SqliteRunError,
  success: SqliteQueryStreamChunk,
  payload: {
...
export class SqliteQueryStreamClose extends Schema.TaggedRequest<SqliteQueryStreamClose>()("SqliteQueryStreamClose", {
  failure: SqliteRunError,
  success: Schema.Void,
  payload: {
    streamId: Schema.String
...
export class SqliteInvalidateTablesEvent extends Schema.TaggedClass<SqliteInvalidateTablesEvent>()(
...
export const SqliteUpdateEvent = Schema.Union(
...
export const SqliteBroadcastEvent = Schema.Union(SqliteUpdateHookEvent, SqliteInvalidateTablesEvent)
