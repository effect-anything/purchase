...
const makeCommercialStateStoreEffect = Effect.gen(function* () {
...
export const CommercialStateStoreLayer = Layer.effect(CommercialStateStore, makeCommercialStateStoreEffect)
