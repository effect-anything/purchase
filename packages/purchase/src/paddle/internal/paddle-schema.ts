...
const Checkout = Schema.Struct({
  url: Schema.String.pipe(Schema.optionalWith({ exact: true, nullable: true }))
})
...
const TransactionPreviewDetails = Schema.Struct({
  tax_rates_used: Schema.Array(TaxRatesUsed),
  totals: DetailsTotals,
  line_items: Schema.Array(LineItem)
})

const SubscriptionPreviewTransaction = Schema.Struct({
  billing_period: BillingPeriod,
  details: TransactionPreviewDetails,
  adjustments: Schema.Array(Schema.Any)
})
...
export class PaddleSubscriptionPreview extends Schema.Class<PaddleSubscriptionPreview>("PaddleSubscriptionPreview")({
  id: Schema.String,
  currency_code: Schema.String,
  current_billing_period: BillingPeriod.pipe(Schema.optionalWith({ exact: true, nullable: true })),
  items: Schema.Array(SubscriptionItem),
  immediate_transaction: SubscriptionPreviewTransaction.pipe(Schema.optionalWith({ exact: true, nullable: true })),
  next_transaction: SubscriptionPreviewTransaction.pipe(Schema.optionalWith({ exact: true, nullable: true })),
  recurring_transaction_details: TransactionPreviewDetails
}) {}

export class PaddleTransactionPreview extends Schema.Class<PaddleTransactionPreview>("PaddleTransactionPreview")({
  customer_id: Schema.String.pipe(Schema.optionalWith({ exact: true, nullable: true })),
  ...
  details: TransactionPreviewDetails,
  available_payment_methods: Schema.Array(PaymentMethodType)
}) {}
...
export const PaddleError = Schema.Struct({
  error: Schema.Struct({
...
export class PaddleAdjustment extends Schema.Class<PaddleAdjustment>("PaddleAdjustment")({
  id: Schema.String,
  action: Schema.String,
  transaction_id: Schema.String,
  subscription_id: Schema.optionalWith(Schema.String, { exact: true, nullable: true }),
  customer_id: Schema.optionalWith(Schema.String, { exact: true, nullable: true }),
  currency_code: Schema.String,
  status: Schema.String,
  totals: Schema.Struct({
    total: Schema.String
...
export class PaddleCustomerPortalSession extends Schema.Class<PaddleCustomerPortalSession>(
