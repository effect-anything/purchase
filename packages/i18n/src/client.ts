...
import { type BackendModule, createInstance, type InitOptions, type LanguageDetectorModule } from "i18next"
...
export const initI18n = ({
  ...
  const ins = createInstance().use(MyDetector).use(initReactI18next).use(resourcesToBackend(load))
