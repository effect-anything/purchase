...
export interface Plan {
  ...
  readonly commands: Array<CommandRequestHandle<any>>

  readonly events: Array<EventRequestHandle<any>>
...
> implements Plan {
  ...
  constructor(
    ...
    options: {
      immediate?: A
      background?: B
      commands?: Array<CommandRequestHandle<any>>
      events?: Array<EventRequestHandle<any>>
    }
  ) {
    this.name = name
...
export class EventHandle {
  private list: Array<EventRequestHandle<any>>
