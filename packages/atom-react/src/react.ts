...
export const defaultRegistry = globalValue("@effect-atom/atom-react/defaultRegistry", () => makeDefaultRegistry())
...
export function useAtomRefBinding<A extends Record<string, any>, P extends keyof A, B>(
  ...
  const setValue = (setStateAction: SetStateAction<B>) => {
    ref.update((_) => ({
      ..._,
      [key]: g(typeof setStateAction === "function" ? (setStateAction as any)(_[key]) : setStateAction)
    }))
  }
  return {
    value,
