...
export const SyncAgentClientConfig = Context.GenericTag<SyncAgentClientConfig>(
  "@effect-x/event-log-server/RpcClient/SyncAgentClientConfig"
)

export class SyncAgentClient extends Context.Tag("@effect-x/event-log-server/RpcClient/SyncAgentClient")<
  SyncAgentClient,
  {
