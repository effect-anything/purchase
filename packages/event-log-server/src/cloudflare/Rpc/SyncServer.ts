...
import * as RpcClient_ from "./Client.ts"

export const SerializationLive = RpcSerialization.layerMsgPack

export class SyncServerError extends Schema.TaggedError<SyncServerError>()("SyncServerError", {
...
export const SyncServerConfig = Context.GenericTag<SyncServerConfig>(
  "@effect-x/event-log-server/RpcClient/SyncServerConfig"
)

export class SyncServerClient extends Context.Tag("@effect-x/event-log-server/RpcClient/SyncServerClient")<
  SyncServerClient,
  {
    write: (
      data: Uint8Array<ArrayBufferLike>
    ) => Effect.Effect<
      { readonly response: Uint8Array<ArrayBufferLike>; readonly changes: ReadonlyArray<Uint8Array<ArrayBufferLike>> },
      SyncServerError
    >
    requestChanges: (
      startSequence: number
    ) => Effect.Effect<{ readonly changes: ReadonlyArray<Uint8Array<ArrayBufferLike>> }, SyncServerError>
  }
>() {
