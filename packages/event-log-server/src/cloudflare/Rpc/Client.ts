...
const WSSocket = Context.GenericTag<WSSocket>("@effect-x/event-log-server/RpcClient/WSSocket")
...
export const Websocket = Context.GenericTag<WebSocket>("@effect-x/event-log-server/RpcClient/Websocket")
