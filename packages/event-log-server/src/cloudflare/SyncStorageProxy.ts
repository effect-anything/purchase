...
import { SerializationLive, type SqlExecPayload, StorageProxyRpcs } from "./Rpc/SyncStorageProxy.ts"
...
}): new (ctx: DurableObjectState, env: any) => StorageProxyDurableObject => {
