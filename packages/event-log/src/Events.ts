...
import type * as EventJournal from "./EventJournal.ts"
...
>(
  ...
  return EventLogClientFactory as unknown as EventLogClient.Factory<Events>
}
...
interface EventLogClientType<Events extends Event.Event.Any> {
  ...
  readonly trigger: <Tag extends Event.Event.Tag<Events>>(
    event: Tag,
    payload: Event.Event.PayloadWithTag<Events, Tag>
  ) => Effect.Effect<any, EventJournal.EventJournalError | any, EventLog.EventLog>
}
export declare namespace EventLogClient {
  export type Any = EventLogClientType<any>

  export type Factory<Events extends Event.Event.Any> = EventLogClientType<Events>
