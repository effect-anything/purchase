/**
 * Event module provides the core event type definitions and utilities for the event sourcing system.
 */
 ...
 * @category type ids
 */
export const TypeId: unique symbol = Symbol.for("@effect-x/event-log/Event")
 ...
 * They include a tag for identification, payload data, and optional success/error schemas.
 *
 * @since 1.0.0
 * @category models
 */
...
> {
  ...
  readonly tag: Tag
  /** Function to generate a primary key from the payload */
  readonly primaryKey: (payload: Schema.Schema.Type<Payload>) => string
  /** Schema for the event payload */
  readonly payload: Payload
  /** MsgPack schema for serializing the payload */
  readonly payloadMsgPack: MsgPack.schema<Payload>
  /** Schema for successful event processing result */
  readonly success: Success
  /** Schema for event processing errors */
...
export declare namespace Event {
   ...
   * @category models
   */
  export type AddError<A extends Any, AddedError extends Schema.Schema.Any> =
    A extends Event<infer _Tag, infer _Payload, infer _Success, infer _Error>
      ? Event<_Tag, _Payload, _Success, _Error | AddedError>
      : never
   ...
   * @category models
   */
  export type WithTag<Events extends Any, EventTag extends string> = Extract<Events, { readonly tag: EventTag }>

  /**
   * @since 1.0.0
   * @category models
   */
  export type ExcludeTag<Events extends Any, EventTag extends string> = Exclude<Events, { readonly tag: EventTag }>

  /**
   * @since 1.0.0
   * @category models
   */
  export type PayloadWithTag<Events extends Any, EventTag extends string> = Payload<WithTag<Events, EventTag>>

  /**
   * @since 1.0.0
   * @category models
   */
  export type SuccessWithTag<Events extends Any, EventTag extends string> = Success<WithTag<Events, EventTag>>

  /**
   * @since 1.0.0
   * @category models
   */
  export type ErrorWithTag<Events extends Any, EventTag extends string> = Error<WithTag<Events, EventTag>>

  /**
   * @since 1.0.0
   * @category models
   */
  export type ContextWithTag<Events extends Any, EventTag extends string> = Context<WithTag<Events, EventTag>>
}
