import type { InvalidMnemonicError } from "./Error.ts"
import type { RemotePublicKeySyncStats, StoragePublicKeyItem } from "./Schema.ts"
...
export const Identity = Context.GenericTag<Identity, Identity>("@effect-x/event-log/Identity")
