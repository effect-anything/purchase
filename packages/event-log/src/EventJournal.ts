 ...
 * @category errors
 */
export const ErrorTypeId: unique symbol = Symbol.for("@effect-x/event-log/EventJournal/ErrorId")
 ...
 * @category errors
 */
export class EventJournalError extends Schema.TaggedError<EventJournalError>("@effect-x/event-log/EventJournal/Error")(
  "EventJournalError",
  {
 ...
 * @since 1.0.0
 */
export class EventJournal extends Context.Tag("@effect-x/event-log/EventJournal")<
  EventJournal,
  {
    /**
 ...
 * @category remote
 */
export const RemoteIdTypeId: unique symbol = Symbol.for("@effect-x/event-log/EventJournal/RemoteId")
 ...
 * @category entry
 */
export const EntryIdTypeId: unique symbol = Symbol.for("@effect-x/event-log/EventJournal/EntryId")
 ...
 * @category entry
 */
export class Entry extends Schema.Class<Entry>("@effect-x/event-log/EventJournal/Entry")({
  id: EntryId,
  event: Schema.String,
 ...
 * @category entry
 */
export class RemoteEntry extends Schema.Class<RemoteEntry>("@effect-x/event-log/EventJournal/RemoteEntry")({
