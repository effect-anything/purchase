 ...
 * @category protocol
 */
export class Hello extends Schema.TaggedClass<Hello>("@effect-x/event-log/EventLogRemote/Hello")("Hello", {
...
export class ChunkedMessage extends Schema.TaggedClass<ChunkedMessage>(
  "@effect-x/event-log/EventLogRemote/ChunkedMessage"
)("ChunkedMessage", {
  id: Schema.Number,
  ...
  static join(
    ...
    let offset = 0
    for (const chunk of entry.parts) {
 ...
 * @category protocol
 */
export class WriteEntries extends Schema.TaggedClass<WriteEntries>("@effect-x/event-log/EventLogRemote/WriteEntries")(
  "WriteEntries",
  {
    id: Schema.Number,
 ...
 * @category protocol
 */
export class Ack extends Schema.TaggedClass<Ack>("@effect-x/event-log/EventLogRemote/Ack")("Ack", {
  id: Schema.Number,
 ...
 * @category protocol
 */
export class Error extends Schema.TaggedClass<Error>("@effect-x/event-log/EventLogRemote/Error")("Error", {
  error: MessageError,
...
export class RequestChanges extends Schema.TaggedClass<RequestChanges>(
  "@effect-x/event-log/EventLogRemote/RequestChanges"
)("RequestChanges", {
 ...
 * @category protocol
 */
export class Changes extends Schema.TaggedClass<Changes>("@effect-x/event-log/EventLogRemote/Changes")("Changes", {
 ...
 * @category protocol
 */
export class StopChanges extends Schema.TaggedClass<StopChanges>("@effect-x/event-log/EventLogRemote/StopChanges")(
  "StopChanges",
  {
 ...
 * @category protocol
 */
export class Ping extends Schema.TaggedClass<Ping>("@effect-x/event-log/EventLogRemote/Ping")("Ping", {
  id: Schema.Number
}) {}
 ...
 * @category protocol
 */
export class Pong extends Schema.TaggedClass<Pong>("@effect-x/event-log/EventLogRemote/Pong")("Pong", {
  id: Schema.Number
}) {}
...
export class ConnectedDevices extends Schema.TaggedClass<ConnectedDevices>(
  "@effect-x/event-log/EventLogRemote/ConnectedDevices"
)("ConnectedDevices", {
...
export class RemoteEventSources extends Context.Tag("@effect-x/event-log/EventLogRemoteEventSources")<
  RemoteEventSources,
  {
