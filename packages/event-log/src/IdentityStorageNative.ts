...
import { IdentityStorage } from "./IdentityStorage.ts"
...
interface NativeStorage {
  ...
  readonly getAllKeys: () => Array<string>
}

const Storage = (
  OPSqlite as unknown as {
    readonly Storage: new (options: { readonly location?: string }) => NativeStorage
  }
).Storage
