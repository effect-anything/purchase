import type { AuditGenerateMnemonicEvent, AuditImportFromMnemonicEvent } from "./Schema.ts"
 ...
 * - 记录助记词，备份，导出（生成、导入）
 */
export class EventLogAudit extends Context.Tag("@effect-x/event-log/EventLogAudit")<
  EventLogAudit,
  {
    recordMnemonicEvent: (
