  ...
  rows={[
    {
      ...
      description: (
        <>
          <code>checkout.start</code>, <code>webhooks.handle</code>, <code>webhooks.replay</code>
        </>
      )
    },
    {
      ...
      description: (
        <>
          <code>portal.createSession</code>, <code>subscriptions.cancel</code>, <code>subscriptions.change</code>,{" "}
          <code>subscriptions.pause</code>, <code>subscriptions.resume</code>, <code>subscriptions.previewChange</code>
        </>
      )
    },
    {
      ...
      description: (
        <>
          <code>purchases.refund</code>, <code>credits.grant</code>, <code>credits.consume</code>
        </>
      )
    }
  ]}
