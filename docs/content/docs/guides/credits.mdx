...
<ApiTable
  ...
  rows={[
    {
      name: "credits.grant",
      description: "Add credits to a customer wallet from a purchase, promotion, or operator action."
    },
    { name: "credits.consume", description: "Spend credits with an idempotent usage record." },
    { name: "credits.getWallet", description: "Read the current wallet balance and related state." }
  ]}
/>
