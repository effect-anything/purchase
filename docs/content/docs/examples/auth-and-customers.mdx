...
- [sign-in page](/examples/nextjs/app/(public)/sign-in/page.tsx)
- [sign-up page](/examples/nextjs/app/(public)/sign-up/page.tsx)
- [auth form](/examples/nextjs/app/(public)/sign-in/sign-in-form.tsx)
- [auth session helpers](/examples/nextjs/lib/auth-session.ts)
